<script lang="ts">
  ...
  const sectionClasses = getSectionClasses('salesCurriculumSection', data.styles)
          ...
          <div class="relative p-8 bg-ultra-light rounded-3xl shadow hover:shadow-md transition-all duration-300">
            ...
            <div class="mt-4">
              <CleanText 
                text={module.title}
                tag="h3"
                className="{theme.headings} text-2xl font-bold mb-4"
              />
              <CleanText 
                text={module.description}
                tag="p"
                className="{theme.text} mb-6"
              />
      ...
      <div class="mt-16 relative overflow-hidden rounded-3xl">
        ...
        <div class="relative z-10 p-10 rounded-3xl text-center">
          <CleanText 
            ...
            tag="h3"
            className="{theme.headings} text-3xl font-medium {bonusBoxStyle.text[style]} mb-6"
          />
          <CleanText 
            text={data.bonusBox.description}
            tag="p"
            className="{theme.text} {bonusBoxStyle.text[style]} mb-8 max-w-2xl mx-auto text-lg leading-relaxed"
          />
