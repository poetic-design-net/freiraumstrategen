      ...
      <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        <div class="p-8 lg:p-12">
          ...
          <div class="text-center mb-12">
            ...
            <div class="flex items-center justify-center gap-4 mb-4">
              <CleanText 
                ...
                className="text-3xl font-light text-gray-400 line-through"
              />
              <CleanText 
                text={data.pricing.currentPrice}
                className="text-5xl font-bold text-primary-800"
              />
            </div>
            <CleanText 
          ...
          <div class="bg-gray-50 rounded-xl p-8 mb-12">
            <h3 class="text-xl font-bold mb-6">Bonus-Pakete im Wert von {data.bonuses.reduce((total, bonus) => total + parseInt(bonus.value.replace(/[^0-9]/g, '')), 0)}€</h3>
            <div class="space-y-6">
