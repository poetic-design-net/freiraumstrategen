<script lang="ts">
  ...
  function handleScroll() {
    ...
    const maxScroll = cardWidth * (posts.length - 1);
  ...
  <div class="flex px-4 justify-end mb-8">
    <div class="w-full lg:w-1/3 px-4">
      <div class="flex items-center justify-end">
        <button 
          on:click={nextSlide} 
          class="inline-flex mr-3 w-14 h-14 items-center justify-center rounded-full bg-gray-100 hover:border-primary-900 text-gray-600 hover:text-primary-900 hover:bg-gray-200 transition duration-200 {currentIndex <= 0 ? 'opacity-50 cursor-not-allowed' : ''}"
        ...
        <button 
          on:click={prevSlide} 
          class="inline-flex w-14 h-14 items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 text-primary-900 transition duration-200 {currentIndex >= posts.length - 1 ? 'opacity-50 cursor-not-allowed' : ''}"
