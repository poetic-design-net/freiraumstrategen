      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full xl:w-1/2 px-4 mb-8 xl:mb-0">
            <div class="relative h-full max-h-[600px]"> <!-- max-height hinzugefügt -->
              <img 
            ...
            <div class="flex flex-wrap h-full -mx-4">
              <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
                <div class="flex flex-col h-full">
                  <a class="relative block h-full mb-7 pt-8 px-8 pb-5 rounded-3xl bg-green-50 hover:bg-green-100 transition duration-200" href="/blog">
              ...
              <div class="w-full md:w-1/2 px-4">
                <a class="relative block h-full pt-8 px-8 pb-5 rounded-3xl bg-primary-50 hover:bg-primary-100 transition duration-200" href="#">
