<script lang="ts">
	...
	import Logo from '$lib/templates/Logo.svelte';	
	let visible = false;    
...
function checkMobile() {
  isMobile = window.innerWidth < 1280; // 1280px ist der Breakpoint für 'xl' in Tailwind
}
	...
	<header class="header">
		<nav class="relative py-6 mb-12 md:mb-24 bg-transparent z-50">
				...
				{:else}
				  <ul class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex lg:w-auto lg:space-x-12">
					<li class="group relative">
					  <a class="inline-block text-sm text-gray-900 hover:text-primary-800 font-light" href="/">Tradingstrategie</a>
					  <div class="hidden group-hover:block absolute top-full left-0 min-w-max max-w-xs p-4 z-50">
						<!-- Dropdown content -->
					  </div>
					</li>
					<li><a class="inline-block text-sm text-gray-900 hover:text-primary-800 font-light" href="/">Schulung</a></li>
					<li><a class="inline-block text-sm text-gray-900 hover:text-primary-800 font-light" href="/">Experten</a></li>
					<li><a class="inline-block text-sm text-gray-900 hover:text-primary-800 font-light" href="/">Blog</a></li>
				  </ul>
				  <div class="ml-auto">
		  ...
		  <nav class="fixed top-0 left-0 bottom-0 w-5/6 max-w-md z-50 bg-white border-r overflow-y-auto">
			<div class="flex items-center justify-between px-4 py-7 mb-10">
			...
			<div class="px-6">
			  <ul class="mb-8">
				<li><a class="block py-4 text-gray-900 hover:bg-primary-50 rounded-lg" href="/">About Us</a></li>
				<li><a class="block py-4 text-gray-900 hover:bg-primary-50 rounded-lg" href="/">Featured</a></li>
				<li><a class="block py-4 text-gray-900 hover:bg-primary-50 rounded-lg" href="/">Solutions</a></li>
				<li><a class="block py-4 text-gray-900 hover:bg-primary-50 rounded-lg" href="/">Products</a></li>
				<li><a class="block py-4 text-gray-900 hover:bg-primary-50 rounded-lg" href="/">Articles</a></li>
			  </ul>
			  ...
			  <div>
				...
				<a class="font-medium text-black" href="/">hello@shuffle.dev</a>
			  </div>
			</div>
		  </nav>
		{/if}
